...
const CaseStudiesList = ({ data }) => {
	...
	if (isUploading) {
		...
		if (editId) {
			...
			// edit case study
			return <EditModal setEditing={setEditing} editId={editId} />;
		} else {
			return (
				<CaseStudiesWrapper>
					<CaseStudiesNav>
						...
						<NavCategoryBox>
							<SelectedNavItem href="#">Case Studies</SelectedNavItem>
							<UnselectedNavItem href="#">Illustrations</UnselectedNavItem>
							<UnselectedNavItem href="#">Photography</UnselectedNavItem>
						</NavCategoryBox>
